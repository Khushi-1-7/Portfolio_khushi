        ...
        <RevealOnScroll>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:shadow-lg transition-all bg-white/5">
              <img
                src="/src/assets/sales.png" // Replace with your project image
                alt="Sales Data Analysis"
              ...
              <p className="text-gray-300 mb-4">
                Built a complete interactive dashboard in Microsoft Excel
                including data cleaning, analysis, and visualization of sales data.
              </p>
              <div className="text-sm text-blue-400 font-medium mb-4">
                Tools: Microsoft Excel, Data Cleaning, Visualization
              </div>
              <a
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:shadow-lg transition-all bg-white/5">
              ...
              <p className="text-gray-300 mb-4">
                Developed a HR analysis dashboard using Excel with multiple tables,
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:shadow-lg transition-all bg-white/5">
              <img
                src="/src/assets/presale.png"
                alt="Pre Sales Forecast"
                className="rounded-lg mb-4 w-full h-48 object-cover"
              />
              <h3 className="text-xl font-semibold text-white mb-2">
                Pre Sales Forecast
              ...
              <p className="text-gray-300 mb-4">
                Created a dynamic sales pipeline forecast tool using Excel formulas,
                multipliers, and VLOOKUP for revenue projections.
              </p>
              <div className="text-sm text-blue-400 font-medium mb-4">
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:shadow-lg transition-all bg-white/5">
              <img
                ...
                alt="Inventory And Supply Chain Management Analysis"
                className="rounded-lg mb-4 w-full h-48 object-cover"
              />
              <h3 className="text-xl font-semibold text-white mb-2">
              ...
              <p className="text-gray-300 mb-4">
                Conducted a comprehensive analysis of inventory and supply chain
                processes to identify inefficiencies and recommend improvements.
              </p>
              <div className="text-sm text-blue-400 font-medium mb-4">
